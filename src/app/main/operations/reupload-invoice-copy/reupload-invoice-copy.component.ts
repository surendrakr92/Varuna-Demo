...
@Component({
  selector: 'app-reupload-invoice-copy',
  templateUrl: './reupload-invoice-copy.component.html',
  styleUrls: ['./reupload-invoice-copy.component.scss']
})
export class ReuploadInvoiceCopyComponent implements OnInit {
